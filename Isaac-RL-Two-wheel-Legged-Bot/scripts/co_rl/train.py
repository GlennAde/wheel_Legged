...
def dump_pickle(file_path: str, data) -> None:
    """Backport of ``isaaclab.utils.io.dump_pickle`` (removed in IsaacLab 2.3).

    Writes a pickle snapshot of a config object next to the yaml files.
    """
